...
public class GameTest {
    ...
    public void Hum_vs_AI() {
        ...
        check_cell_init(player_1, player_2,false);
    }


    private void check_cell_init(Player player_1, Player player_2,boolean isMulti) {
        Game game = new Game(player_1,player_2,isMulti);
